Attribute VB_Name = "QuaterlyStockSummary_Q2"
Sub QuarterlyStockSummary_Q2()
    ...
    For i = 2 To lastRow
        ...
        ' Process only rows within Q2 (April 1, 2022 to June 30, 2022)
        If ws.Cells(i, 2).Value >= DateValue("4/1/2022") And ws.Cells(i, 2).Value <= DateValue("6/30/2022") Then
            ' For the first Q2 row for a ticker, record the opening price (Column C)
