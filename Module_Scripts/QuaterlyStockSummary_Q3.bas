Attribute VB_Name = "QuaterlyStockSummary_Q3"
Sub QuarterlyStockSummary_Q3()
    ...
    For i = 2 To lastRow
        ...
        ' Process only rows within Q3 (July 1, 2022 to September 30, 2022)
        If ws.Cells(i, 2).Value >= DateValue("7/1/2022") And ws.Cells(i, 2).Value <= DateValue("9/30/2022") Then
            ' For the first Q3 row for a ticker, record the opening price (Column C)
